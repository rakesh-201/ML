...
data_list = []
params_list ={}
#C:\Users\USER\Downloads\Li-RUL-master\Li-RUL-master\data_json\B0005_discharge.json
...
def get_params():
    ...
    with open('C:/Users/USER/Downloads/Li-RUL-master/Li-RUL-master/2_params.json', 'r') as f:
