...
def plot_1(preds_list, batt_no, tr_labels):
    ...
    #C:\Users\USER\Downloads\Li-RUL-master\Li-RUL-master\figs
    fig.savefig('C:/Users/USER/Downloads/Li-RUL-master/Li-RUL-master/figs/1_'+str(batt_no)+'.jpg')
...
def plot_2(preds_list, batt_no, tr_labels):
    ...
    plt.legend(loc='upper right', frameon=False)
    plt.figure(figsize=(300,300))
    fig.savefig('C:/Users/USER/Downloads/Li-RUL-master/Li-RUL-master/figs/2_'+str(batt_no)+'.jpg')