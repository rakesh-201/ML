...
path = 'C:/Users/USER/Downloads/Li-RUL-master/Li-RUL-master/data_json/'
...
def get_params():
    ...
    with open('C:/Users/USER/Downloads/Li-RUL-master/Li-RUL-master/1_params.json', 'r') as f:
...
def inference(train, test, batt_no, a, b, c):
...
def main(run = False):
    ...
    if run == False:
        ...
        inference(train, test, batt, a, b, c)
        print('done1\n')
